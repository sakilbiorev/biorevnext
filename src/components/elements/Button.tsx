...
const buttonVariants = cva('', {
  variants: {
    types: {
      default:
        "border-[1px] border-[#000000] bg-[#000000] text-[13px] font-medium uppercase text-white-0 transition-all duration-700 before:absolute before:bottom-[-6px] before:left-[10px] before:h-[1px] before:w-[calc(100%+2px)] before:bg-[#000000] before:transition-all before:duration-700 before:content-[''] after:absolute after:right-[-6px] after:top-[10px] after:box-border after:h-[calc(100%+2px)] after:w-[1px] after:bg-[#000000] after:transition-all after:duration-700 after:content-[''] hover:bg-transparent hover:text-[#000000] hover:before:w-0 hover:after:h-0",
      destructive:
      ...
      orange:
        "border-[1px] border-orange-0 bg-orange-0 text-[13px] font-medium uppercase text-white-0 transition-all duration-700 before:absolute before:bottom-[-6px] before:left-[10px] before:h-[1px] before:w-[calc(100%+2px)] before:bg-orange-0 before:transition-all before:duration-700 before:content-[''] after:absolute after:right-[-6px] after:top-[10px] after:box-border after:h-[calc(100%+2px)] after:w-[1px] after:bg-orange-0 after:transition-all after:duration-700 after:content-[''] hover:bg-transparent hover:text-orange-0 hover:before:w-0 hover:after:h-0",
    },
    size: {
      default: 'px-10 py-5',
      sm: 'px-6 py-3  before:bottom-[-6px] before:left-[10px] after:right-[-6px] after:top-[10px]',
      lg: 'px-12 py-6 before:bottom-[-6px] before:left-[10px] after:right-[-6px] after:top-[10px]',
    },
  },
  defaultVariants: {
    types: 'default',
