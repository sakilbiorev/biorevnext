...
const GalleryMenu = () => {
  return (
    <div className="fixed inset-y-0 right-0 z-[999] h-screen w-[400px] translate-x-0 overflow-hidden bg-black-0 py-[90px] pl-[25px] pr-[42px] transition-all duration-300 ease-linear">
